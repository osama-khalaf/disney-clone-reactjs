...
export default function Original() {
  ...
  React.useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=e6d3cedbec25664ec7c2dbb722aa5e56&sort_by=popularity.desc&with_companies=3475%7C5391%7C109755%7C6125&page=${seeMore}`
    )
